...
export function HeroSection({
  badgeText = "21+ Years of Excellence in Vertical Transportation",
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0">
        <img src={heroBuilding} alt="Modern skyscraper with premium elevator systems" className="w-full h-full object-cover" />
      ...
      <div className="container relative z-10 py-20">
        <div className="max-w-3xl">
          <div className="inline-flex items-center gap-2 bg-gold/20 border border-gold/30 rounded-full px-4 py-2 mb-8 animate-fade-in">
            ...
            <span className="text-gold text-sm font-medium">{badgeText}</span>
          </div>
