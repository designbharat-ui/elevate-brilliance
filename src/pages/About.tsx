...
export default function About() {
  const { page, getField } = usePageContent("about");

  const heroLabel = getField("hero", "label", "About Us");
  const heroTitle = getField("hero", "title", "21+ Years of Excellence in Vertical Transportation");
  const heroDescription = getField("hero", "description", "Rising Star Elevator Pvt. Ltd. — a growing organization managed by a team of highly qualified technocrats with vast experience in vertical transportation and passenger flow.");
  
  const companyLabel = getField("company", "label", "The Company");
  const companyTitle = getField("company", "title", "Building Trust Through Quality & Service");
  const companyFields = page?.sections.find(s => s.id === "company")?.fields;
  const companyParagraphs = companyFields?.paragraphs || [
    ...
    <div className="min-h-screen">
      ...
      <main>
          ...
          <div className="container relative z-10">
            <div className="max-w-3xl">
              ...
              <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-primary-foreground mb-6">
                {heroTitle.includes("Excellence") ? (
                  <>{heroTitle.split("Excellence")[0]}<span className="text-gradient-gold">Excellence</span>{heroTitle.split("Excellence")[1]}</>
                ) : heroTitle}
              </h1>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <h2 className="font-display text-3xl md:text-4xl font-bold text-foreground mb-6">
                  {companyTitle.includes("Quality") ? (
                    <>Building Trust Through{" "}<span className="text-gradient-gold">Quality & Service</span></>
                  ) : companyTitle}
                </h2>
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  {companyParagraphs.map((p: string, i: number) => (
                    <p key={i}>{p}</p>
                  ))}
                </div>
          ...
          <div className="container">
            <div className="text-center max-w-3xl mx-auto mb-12">
              ...
              <h2 className="font-display text-3xl md:text-4xl font-bold text-foreground mb-4">
                Vision, Values &{" "}<span className="text-gradient-gold">Mission</span>
              </h2>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-card border border-border rounded-lg p-8 hover:shadow-lg transition-all">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  To change the expectation of the customers by raising their expectations to the next level of demand in terms of product, offerings and services. To offer trouble-free performance and unique aesthetics that ensure complete customer satisfaction.
                </p>
              ...
              <div className="bg-card border border-border rounded-lg p-8 hover:shadow-lg transition-all">
                ...
                <ul className="space-y-3 text-muted-foreground leading-relaxed mb-4">
                  <li className="flex gap-2"><CheckCircle className="w-4 h-4 text-gold flex-shrink-0 mt-1" /><span className="text-sm">Respectable, honest, ethical and transparent dealings with all customers and vendors.</span></li>
                  <li className="flex gap-2"><CheckCircle className="w-4 h-4 text-gold flex-shrink-0 mt-1" /><span className="text-sm">Dedication to social responsibility and strengthening social status.</span></li>
                  <li className="flex gap-2"><CheckCircle className="w-4 h-4 text-gold flex-shrink-0 mt-1" /><span className="text-sm">Environmental consciousness in all our actions.</span></li>
                </ul>
                <div className="bg-gold/10 border-l-4 border-gold px-4 py-2 rounded-r-lg">
              ...
              <div className="bg-card border border-border rounded-lg p-8 hover:shadow-lg transition-all">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  To offer high quality product with touch & feel technology and to become feel good service provider till infinity. We supply equipment with specifications better than competitors, with pre-defined processes for installation and post-handover services.
                </p>
                <div className="bg-gold/10 border-l-4 border-gold px-4 py-2 rounded-r-lg">
        ...
        <section className="py-16 md:py-20 bg-background">
          <div className="container">
            <div className="text-center max-w-3xl mx-auto mb-12">
              <span className="inline-block text-gold font-medium tracking-widest uppercase text-sm mb-4">Our Expertise</span>
              <h2 className="font-display text-3xl md:text-4xl font-bold text-foreground mb-4">
                Three Pillars of{" "}<span className="text-gradient-gold">Our Business</span>
              </h2>
              <p className="text-muted-foreground">Covering three important areas of construction</p>
              <div className="divider-gold mx-auto mt-4" />
            </div>
            <div className="grid md:grid-cols-3 gap-8">
              {defaultBusinessAreas.map((area) => (
        ...
        <section className="section-padding bg-secondary">
          <div className="container">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <span className="inline-block text-gold font-medium tracking-widest uppercase text-sm mb-4">Our Journey</span>
              <h2 className="font-display text-3xl md:text-4xl font-bold text-foreground mb-4">
                Two Decades of{" "}<span className="text-gradient-gold">Growth</span>
              </h2>
              <div className="divider-gold mx-auto" />
            </div>
            <div className="relative">
        ...
        <section className="section-padding bg-primary">
          <div className="container">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <span className="inline-block text-gold font-medium tracking-widest uppercase text-sm mb-4">Our Team</span>
              <h2 className="font-display text-3xl md:text-4xl font-bold text-primary-foreground mb-4">
                Expert Professionals at Your{" "}<span className="text-gradient-gold">Service</span>
              </h2>
              <div className="divider-gold mx-auto" />
            </div>
        ...
        <section className="section-padding bg-secondary">
          <div className="container">
            <div className="text-center max-w-3xl mx-auto mb-12">
              <span className="inline-block text-gold font-medium tracking-widest uppercase text-sm mb-4">Certifications</span>
              <h2 className="font-display text-3xl md:text-4xl font-bold text-foreground mb-4">
                Quality{" "}<span className="text-gradient-gold">Assured</span>
              </h2>
            </div>
