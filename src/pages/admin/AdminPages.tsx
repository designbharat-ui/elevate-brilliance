            ...
            {filtered.map((page) => (
              <Card key={page.id} className="p-4 flex items-center justify-between hover:shadow-md transition-shadow">
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-muted-foreground">/{page.slug} • Updated {new Date(page.updated_at).toLocaleDateString()}</p>
                </div>
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      ...
                      <AlertDialogFooter>
                        ...
                        <AlertDialogAction onClick={() => deletePage(page.id)} className="bg-destructive text-destructive-foreground">Delete</AlertDialogAction>
                      </AlertDialogFooter>
                    </AlertDialogContent>
                  </AlertDialog>
                </div>
